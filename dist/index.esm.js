...
var Text = styled.div(
  templateObject_1$18 ||
    (templateObject_1$18 = __makeTemplateObject(
      [
        '\n  color: ',
        ';\n  font-size: ',
        ';\n  font-weight: ',
...
var Icon$1X = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 23 22' }, props),
    React__default.createElement('path', {
      d: 'M21.5 1l-20 20',
      strokeWidth: 2,
      stroke: 'currentColor',
...
var Icon$1G = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 20 16' }, props),
    React__default.createElement('path', {
...
var Icon$1E = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 22 20' }, props),
...
var Icon$1B = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 25 24' }, props),
    React.createElement('path', {
...
var Icon$1m = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 23 21' }, props),
    React__default.createElement('path', {
...
var Icon$1j = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 198 199' }, props),
    React__default.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
...
var Logo$2 = function (_a) {
  ...
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 1281 199' }, props),
    React__default.createElement('path', {
...
var Icon$13 = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 19 20' }, props),
    React.createElement('path', {
...
var Icon$k = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '0 0 21 11' }, props),
    React__default.createElement('path', {
...
var Icon$j = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 18 20' }, props),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
...
var Icon$h = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 19 17' }, props),
    React.createElement('path', {
...
var Icon$e = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 18 15' }, props),
    React.createElement('path', {
...
var ExpandableButton = function (_a) {
  ...
  return React__default.createElement(
    ...
    children,
    expanded
      ? React__default.createElement(Icon$1Q, { color: 'invertedContrast' })
      : React__default.createElement(Icon$1T, { color: 'invertedContrast' })
  );
};
  ...
  return React__default.createElement(
    Button,
    {
      ...
      endIcon: expanded
        ...
        : React__default.createElement(Icon$1T, { color: 'primary' }),
    },
    children
  );
};
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      typeof children === 'string'
        ? React__default.createElement(Text, { as: 'p' }, children)
        : children
    ),
    onClick &&
      React__default.createElement(
...
var DefaultSeparator = React__default.createElement(Icon$1R, {
  color: 'currentColor',
  width: '24px',
});
...
var getBorderColor$1 = function (_a) {
  var theme = _a.theme,
    variant = _a.variant;
  return theme.colors[
    variant === variants$6.SUBTLE ? 'inputSecondary' : 'disabled'
  ];
};
...
var ButtonMenu$1 = function (_a) {
  ...
  return React__default.createElement(
    StyledButtonMenu,
    __assign(
      { disabled: disabled, variant: variant, fullWidth: fullWidth },
      props
    ),
...
var UnmountAnimation = keyframes(
  templateObject_2$u ||
...
var getState = function () {
  var s = Object.keys(mediaQueries).reduce(function (accum, size) {
    ...
    return __assign(
      ...
      ((_b = {}),
      (_b[key] =
        (_c = mql === null || mql === void 0 ? void 0 : mql.matches) !== null &&
        _c !== void 0
          ? _c
          : false),
      _b)
...
var Overlay = function (props) {
  return React__default.createElement(
    ...
    React__default.createElement(
      StyledOverlay,
      __assign({ role: 'presentation' }, props)
    )
  );
};
...
var getPortalRoot = function () {
  ...
  return (
    ...
    ((_a = document.getElementById('portal-root')) !== null && _a !== void 0
      ? _a
      : document.body)
  );
};
...
var CakePrice = function (_a) {
  ...
  return cakePriceUsd
    ? React__default.createElement(
        PriceLink,
        {
          href: 'https://hodlx.exchange/swap?outputCurrency=0xAeBdbcc7d6821E3924EE5167b4138a43c19Cf681',
          target: '_blank',
        },
        React__default.createElement(StyledImg, {
          src: '/images/tokens/0xAeBdbcc7d6821E3924EE5167b4138a43c19Cf681.png',
        }),
        React__default.createElement(
          Text,
          { color: color, bold: true },
          '$' + cakePriceUsd.toFixed(8)
        )
      )
    : React__default.createElement(Skeleton, { width: 80, height: 24 });
};
...
var BackgroundImage = function (_a) {
  ...
  var ref = useRef(null);
  var placeholder =
    loadingPlaceholder || React__default.createElement(Placeholder, null);
  useEffect(
    function () {
      var observer;
      if (ref.current) {
...
var Image = function (_a) {
  ...
  return React__default.createElement(
    ...
    isLoaded
      ? React__default.createElement(StyledImage, { src: src, alt: alt })
...
var TokenPairImage = function (_a) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      StyledPrimaryImage,
      __assign(
        { variant: variant, src: primarySrc, width: width, height: height },
        primaryImageProps
      )
    ),
    React__default.createElement(
...
var StyledBunnyPlaceholder = styled(Icon$20)(
  templateObject_2$n ||
...
var ProfileAvatar = function (props) {
  return React__default.createElement(
    ...
    __assign(
      {
        loadingPlaceholder: React__default.createElement(
          StyledBunnyPlaceholder,
          null
        ),
      },
      props
...
var InputGroup = function (_a) {
  ...
  return React__default.createElement(
    ...
    startIcon &&
      React__default.createElement(InputIcon, { scale: scale }, startIcon),
    cloneElement(children, { scale: scale }),
    endIcon &&
      React__default.createElement(
        InputIcon,
        { scale: scale, isEndIcon: true },
        endIcon
      )
  );
};
...
var LinkExternal = function (_a) {
  ...
  return React__default.createElement(
    ...
    children,
    React__default.createElement(Icon$10, {
...
var lightColors = __assign(
  __assign(__assign({}, baseColors), additionalColors),
  {
    background: '#FAF9FA',
...
var darkColors = __assign(
  __assign(__assign({}, baseColors), additionalColors),
  {
    secondary: '#7a92dc',
    background: '#000316',
    backgroundDisabled: '#24374a',
    backgroundAlt: '#000316',
...
var Progress = function (_a) {
  ...
  return React__default.createElement(
    StyledProgress,
    { $useDark: useDark, variant: variant, scale: scale },
    children ||
      React__default.createElement(
        React__default.Fragment,
        null,
...
var sliderHodlHand =
  'data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink
22.92c-2.07%205.25-1.38%2010.41.85%2014.77M135%2069.56c.45%202.12.6%204.62.39%207.57-1.34%2018.34-19.81%2018.19-19.81%2018.19s23.99-.63%2023.99%2021.79m-43.45%2031.11s-37.68-4.75-37.68-41.26%2042.96-46.62%2052.33-47.99a65.15%2065.15%200%200%201%203.68-.45%22%2F%3E%3C%2Fdefs%3E%3C%2Fsvg%3E';

var sliderStart =
  'data:image/svg+xml,%3csvg%20xmlns%3d%22http%3a%2f%2fwww.w3.org%2f2000%2fsvg%22%20fill%3d%22none%22%20viewBox%3d%220%200%2015%2032%22%20height%3d%2232%22%20width%3d%2215%22%3e%0d%0a%3cpath%20d%3d%22M0.96610169%2023.061769C0.97098991%2020.007072%203.1427273%2018%206.231271%2018H15V28H6.1755086C2.9615514%2028%200.96106736%2026.20778%200.96610169%2023.061769Z%22%20fill%3d%22%230098ff%22%20%2f%3e%0d%0a%3c%2fsvg%3e';
...
var getBaseThumbStyles = function (_a) {
  ...
  return (
    ...
    (disabled
      ? 'scale(1) translate(-3px, 1px)'
      : 'scale(1.1) translate(-3px, -2px)') +
    ';\n  }\n'
  );
};
...
var Slider = function (_a) {
  ...
  var labelProgress = isMax
    ? 'calc(100% - 12px)'
    : progressPercentage * 0.94 + '%';
...
var RotatingPancakeIcon = styled(Icon$1)(
  templateObject_4$5 ||
...
var FloatingPanIcon = styled(Icon$2)(
  templateObject_5$3 ||
...
var rotate$11 = keyframes(
  templateObject_11$r ||
    (templateObject_11$r = __makeTemplateObject(
      [
        '\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n',
      ],
      [
...
var Container$11 = styled.div(
  templateObject_2$61 ||
    (templateObject_2$61 = __makeTemplateObject(
      ['\n  position: relative;\n'],
      ['\n  position: relative;\n']
    ))
);
var RotatingPancakeIcon = styled(SpinnerIcon)(
  templateObject_3$21 ||
    (templateObject_3$21 = __makeTemplateObject(
      [
        '\n top: 0;\n  left: 0;\n  animation: ',
        ' 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n',
      ],
...
var InlineMenuContainer = styled(Box)(
  templateObject_1$p ||
    (templateObject_1$p = __makeTemplateObject(
      [
        '\n  background-color: ',
...
var SubMenuContainer = styled(Flex)(
  templateObject_2$f ||
...
var BaseMenu = function (_a) {
  ...
  var placement =
    (_b =
      options === null || options === void 0 ? void 0 : options.placement) !==
      null && _b !== void 0
      ? _b
      : 'bottom';
  var offset =
    (_c = options === null || options === void 0 ? void 0 : options.offset) !==
      null && _c !== void 0
      ? _c
      : [0, 10];
  var padding =
    (_d = options === null || options === void 0 ? void 0 : options.padding) !==
      null && _d !== void 0
      ? _d
      : { left: 16, right: 16 };
  ...
  var menu = React__default.createElement(
    'div',
...
var StyledMenuItemContainer = styled.div(
  templateObject_1$o ||
    (templateObject_1$o = __makeTemplateObject(
      ['\n  position: relative;\n\n  ', ';\n'],
      ['\n  position: relative;\n\n  ', ';\n']
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      __assign(
        {},
        itemLinkProps,
        { $isActive: isActive, $variant: variant, $statusColor: statusColor },
        props
      ),
      children
    )
...
var IconComponent = function (_a) {
  ...
  return IconElement
    ? React__default.createElement(IconElement, __assign({}, props))
    : null;
};

var StyledSubMenuItems = styled(Flex)(
  templateObject_1$n ||
    (templateObject_1$n = __makeTemplateObject(
      [
        '\n  ',
...
var SubMenuItems = function (_a) {
  ...
  return React__default.createElement(
    ...
    __assign(
      ...
      props,
      { pl: ['12px', null, '0px'], $isMobileOnly: isMobileOnly }
    ),
    items.map(function (_a) {
      var label = _a.label,
        href = _a.href,
        iconName = _a.iconName,
        itemProps = _a.itemProps;
      return (
        label &&
        React__default.createElement(
          Box,
          ...
          React__default.createElement(
            MenuItem,
            __assign(
              { href: href, isActive: href === activeItem, variant: 'subMenu' },
              itemProps
            ),
            iconName &&
...
var Toggle = function (_a) {
  var checked = _a.checked,
    _b = _a.defaultColor,
    defaultColor = _b === void 0 ? 'secondary' : _b,
    _c = _a.checkedColor,
...
var useTooltip = function (content, options) {
  ...
  return {
    ...
    tooltip:
      tooltipInPortal !== null && tooltipInPortal !== void 0
        ? tooltipInPortal
        : tooltip,
...
var InfoTooltip = function (_a) {
  ...
  return React__default.createElement(
    Flex,
    __assign({}, props, { alignItems: 'center' }),
    tooltipVisible && tooltip,
    React__default.createElement(
      Flex,
      { ref: targetRef, alignItems: 'center' },
      React__default.createElement(IconComponent, {
        iconName: 'Info',
        color: iconColor,
      })
...
var TimelineContainer = styled.ul(
  templateObject_1$f ||
    (templateObject_1$f = __makeTemplateObject(
      ['\n  display: flex;\n  flex-direction: column;\n  list-style: none;\n'],
      ['\n  display: flex;\n  flex-direction: column;\n  list-style: none;\n']
...
var Timeline = function (_a) {
  ...
  return React__default.createElement(
    ...
    events.map(function (_a) {
      ...
      return React__default.createElement(
        TimelineEvent,
        { key: text, $useDark: useDark },
        React__default.createElement(
          Flex,
          { mr: '10px', alignItems: 'center' },
          isUpcoming &&
            React__default.createElement(IconComponent, {
          ...
          isLive &&
            React__default.createElement(IconComponent, { iconName: 'Logo' }),
          isPast &&
            React__default.createElement(IconComponent, {
        ...
        React__default.createElement(
          Text,
          {
            color: getTextColor$1({ eventStatus: status, useDark: useDark }),
            bold: true,
          },
          text
        ),
        altText &&
          React__default.createElement(
            Text,
            { color: 'warning', ml: '2px', bold: true },
            altText
          ),
        infoText &&
          React__default.createElement(InfoTooltip, {
            text: infoText,
            ml: '10px',
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        null,
        onBack &&
          React__default.createElement(ModalBackButton, { onBack: onBack }),
...
var StyledAnimatedIconComponent = styled.div(
  templateObject_2$7 ||
...
var AnimatedIconComponent = function (_a) {
  ...
  return IconElement
    ? React__default.createElement(
        ...
        __assign({ isActive: isActive, hasFillIcon: hasFillIcon }, props),
        React__default.createElement(
          StyledIconContainer,
        ...
        hasFillIcon &&
          React__default.createElement(
            StyledIconContainer,
            __assign({ activeBackgroundColor: activeBackgroundColor }, props),
...
var StyledBottomNavItem = styled.button(
  templateObject_1$b ||
    (templateObject_1$b = __makeTemplateObject(
      [
        '\n  display: block;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  height: 44px;\n  padding: 4px 12px;\n  &:hover {\n    border-radius: 16px;\n  }\n  &:hover,\n  &:hover div {\n    background: ',
...
var StyledBottomNavText = styled(Text)(
  templateObject_2$6 ||
...
var BottomNavItem = function (_a) {
  ...
  var linkComponent = useContext(MenuContext).linkComponent;
  var bottomNavItemContent = React__default.createElement(
    Flex,
    {
    ...
    iconName &&
      React__default.createElement(AnimatedIconComponent, {
        iconName: iconName,
        height: '22px',
        width: '21px',
  ...
  return showItemsOnMobile
    ...
    : React__default.createElement(
        StyledBottomNavItem,
        __assign({ as: linkComponent, href: href }, props),
        bottomNavItemContent
      );
};

var StyledBottomNav = styled(Flex)(
  templateObject_1$a ||
    (templateObject_1$a = __makeTemplateObject(
      [
        '\n  position: fixed;\n  bottom: 0px;\n  width: 100%;\n  padding: 5px 8px;\n  background: ',
...
var DropdownMenuItem = styled.button(
  templateObject_1$9 ||
...
var StyledDropdownMenuItemContainer = styled.div(
  templateObject_2$5 ||
...
var DropdownMenuDivider = styled.hr(
  templateObject_3$3 ||
...
var StyledDropdownMenu = styled.div(
  templateObject_4$1 ||
...
(function (DropdownMenuItemType) {
  DropdownMenuItemType[(DropdownMenuItemType['INTERNAL_LINK'] = 0)] =
    'INTERNAL_LINK';
  DropdownMenuItemType[(DropdownMenuItemType['EXTERNAL_LINK'] = 1)] =
    'EXTERNAL_LINK';
  ...
  return React__default.createElement(
    ...
    hasItems &&
      React__default.createElement(
        StyledDropdownMenu,
        __assign(
          { style: styles.popper, ref: setTooltipRef },
          attributes.popper,
          { $isBottomNav: isBottomNav, $isOpen: isMenuShow }
        ),
        items
          ...
          .map(function (_a, itemItem) {
            ...
            var MenuItemContent = React__default.createElement(
              React__default.Fragment,
              null,
              label,
              status &&
            ...
            return React__default.createElement(
              ...
              type === DropdownMenuItemType.BUTTON &&
                React__default.createElement(
                  DropdownMenuItem,
                  __assign({ $isActive: isActive, type: 'button' }, itemProps),
                  MenuItemContent
                ),
              ...
              type === DropdownMenuItemType.DIVIDER &&
                React__default.createElement(DropdownMenuDivider, null)
            );
          })
      )
  );
...
var BottomNav = function (_a) {
  ...
  var isBottomMenuOpen = Object.values(menuOpenByIndex).reduce(function (
    acc,
    value
  ) {
    return acc || value;
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      StyledBottomNav,
      __assign({ justifyContent: 'space-around' }, props),
        ...
        return (
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                NotificationDot,
                { show: !!statusColor, color: statusColor },
...
var StyledLogoWithTextIcon = styled.img(
  templateObject_3$2 ||
...
var Logo = function (_a) {
  ...
  var innerLogo = React__default.createElement(
    React__default.Fragment,
    null,
    React__default.createElement(StyledLogoWithTextIcon, {
  ...
  return React__default.createElement(
    ...
    isAbsoluteUrl
      ...
      : React__default.createElement(
          StyledLink,
          { href: href, as: linkComponent, 'aria-label': 'Pancake home page' },
          innerLogo
        )
  );
};
...
var LangSelector = function (_a) {
  ...
  return React__default.createElement(
    Dropdown,
    {
      ...
      target: React__default.createElement(
        Button,
        {
          scale: buttonScale,
          variant: 'text',
          startIcon: React__default.createElement(Icon$1p, {
            color: color,
            width: '24px',
          }),
        },
...
var LangSelector$1 = React__default.memo(LangSelector, function (prev, next) {
...
var TopBannerContainer = styled.div(
  templateObject_4 ||
...
var Menu$1 = function (_a) {
  var _b;
  var _c = _a.linkComponent,
    linkComponent = _c === void 0 ? 'a' : _c,
  ...
  var subLinksWithoutMobile =
    subLinks === null || subLinks === void 0
      ? void 0
      : subLinks.filter(function (subLink) {
          return !subLink.isMobileOnly;
        });
  var subLinksMobileOnly =
    subLinks === null || subLinks === void 0
      ? void 0
      : subLinks.filter(function (subLink) {
          return subLink.isMobileOnly;
  ...
  return React__default.createElement(
    ...
    { value: { linkComponent: linkComponent } },
    React__default.createElement(
      Wrapper,
      null,
      React__default.createElement(
        FixedContainer,
        { showMenu: showMenu, height: totalTopMenuHeight },
        banner &&
          React__default.createElement(
            TopBannerContainer,
      ...
      subLinks &&
        React__default.createElement(
          Flex,
          { justifyContent: 'space-around' },
          React__default.createElement(SubMenuItems, {
            items: subLinksWithoutMobile,
            mt: totalTopMenuHeight + 1 + 'px',
            activeItem: activeSubItem,
          }),
          (subLinksMobileOnly === null || subLinksMobileOnly === void 0
            ? void 0
      ...
      isMobile &&
        React__default.createElement(BottomNav, {
          items: links,
          activeItem: activeItem,
          activeSubItem: activeSubItem,
        })
...
var UserMenu = function (_a) {
  ...
  return React__default.createElement(
    Flex,
    __assign(
      { alignItems: 'center', height: '100%', ref: setTargetRef },
      props
    ),
    React__default.createElement(
      StyledUserMenu,
...
var Icon = function (props) {
  return React__default.createElement(
    Svg,
    __assign({ viewBox: '-10 0 64 62.03' }, props),
    React__default.createElement('path', {
      fill: '#afd8f7',
...
var MoreWalletCard = function (_a) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(Icon$17, {
      width: '40px',
      mb: '8px',
      color: 'textSubtle',
    }),
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          !showMore &&
            React__default.createElement(MoreWalletCard, {
              t: t,
              onClick: function () {
...
var useWalletModal = function (login, logout, t) {
  var onPresentConnectModal = useModal(
    React__default.createElement(ConnectModal, { login: login, t: t })
  )[0];
...
export {
  Icon$2i as AccountFilledIcon,
  Icon$2h as AccountIcon,
  Icon$2g as AddIcon,
  Alert,
  Icon$2f as ArrowBackIcon,
  Icon$2e as ArrowDownIcon,
  Icon$2d as ArrowDropDownIcon,
  Icon$2c as ArrowDropUpIcon,
  Icon$2b as ArrowFirstIcon,
  Icon$2a as ArrowForwardIcon,
  Icon$29 as ArrowLastIcon,
  Icon$27 as ArrowUpDownIcon,
  Icon$28 as ArrowUpIcon,
  Icon$26 as AutoRenewIcon,
  BackgroundImage,
  BalanceInput,
  GridLayout$1 as BaseLayout,
  BaseMenu,
  Icon$25 as BinanceChainIcon,
  Icon$24 as BinanceIcon,
  Icon$2k as BlockIcon,
  Icon$23 as BnbUsdtPairTokenIcon,
  BottomDrawer,
  Box,
  Breadcrumbs,
  Icon$22 as BscScanIcon,
  Icon$21 as BunnyCardsIcon,
  Icon$20 as BunnyPlaceholderIcon,
  Button,
  ButtonMenu$1 as ButtonMenu,
  ButtonMenuItem,
  CakePrice$1 as CakePrice,
  Icon$1$ as CalculateIcon,
  Icon$1_ as CameraIcon,
  Card,
  CardBody,
  CardFooter,
  CardHeader,
  CardRibbon,
  Icon$1Y as CardViewIcon,
  Icon$1Z as Cards,
  GridLayout as CardsLayout,
  Icon$1X as ChartDisableIcon,
  Icon$1W as ChartIcon,
  Checkbox,
  Icon$1V as CheckmarkCircleFillIcon,
  Icon$2m as CheckmarkCircleIcon,
  Icon$1U as CheckmarkIcon,
  Icon$1T as ChevronDownIcon,
  Icon$1S as ChevronLeftIcon,
  Icon$1R as ChevronRightIcon,
  Icon$1Q as ChevronUpIcon,
  Icon$1P as CircleOutlineIcon,
  ClickableElementContainer,
  Icon$1O as CloseIcon,
  Icon$1N as CogIcon,
  Icon$1M as Coin98Icon,
  Icon$1L as CommunityFilledIcon,
  Icon$1K as CommunityIcon,
  ConnectorNames,
  Icon$1J as CopyIcon,
  Icon$1I as CrownIcon,
  Icon$1H as CurrencyIcon,
  Icon$1G as DiscordIcon,
  Dropdown,
  DropdownMenuItemType,
  Icon$1E as EarnFillIcon,
  Icon$1F as EarnFilledIcon,
  Icon$1D as EarnIcon,
  Icon$1C as EllipsisIcon,
  Icon$2l as ErrorIcon,
  Icon$1B as ExpandIcon,
  ExpandableButton,
  ExpandableLabel,
  FallingBunnies,
  Icon$1A as FarmIcon,
  Flex,
  Icon$1z as GithubIcon,
  Grid,
  Icon$1y as GroupsIcon,
  Icon$1x as HamburgerCloseIcon,
  Icon$1w as HamburgerIcon,
  Heading,
  Icon$1v as HelpIcon,
  Icon$1u as HistoryIcon,
  Icon$1t as HomeIcon,
  IconButton,
  Icon$1s as IfoIcon,
  Image,
  ...
  Input$1 as Input,
  InputGroup,
  Icon$1r as InstagramIcon,
  Icon$1q as LanguageCurrencyIcon,
  Icon$1p as LanguageIcon,
  Icon$1o as LaurelLeftIcon,
  Icon$1n as LaurelRightIcon,
  Icon$1m as LineGraphIcon,
  Link,
  LinkExternal,
  Icon$1l as ListViewIcon,
  Icon$1k as LoginIcon,
  Icon$1j as LogoIcon,
  Icon$1i as LogoRoundIcon,
  LogoWithText as LogoWithTextIcon,
  Icon$1h as LogoutIcon,
  Icon$1g as MathWalletIcon,
  Icon$1f as MedalBronzeIcon,
  Icon$1e as MedalGoldIcon,
  Icon$1d as MedalPurpleIcon,
  Icon$1c as MedalSilverIcon,
  Icon$1b as MedalTealIcon,
  Menu$1 as Menu,
  Message,
  MessageText,
  Icon$1a as MetamaskIcon,
  Icon$19 as MinusIcon,
  Modal,
  ModalBackButton,
  ModalBody,
  ModalCloseButton,
  ...
  ModalTitle,
  Icon$18 as MoonIcon,
  Icon$17 as MoreHorizontalIcon,
  Icon$16 as MoreIcon,
  Icon$15 as MoreVerticalIcon,
  Icon$13 as NftFillIcon,
  Icon$14 as NftFilledIcon,
  Icon$12 as NftIcon,
  Icon$11 as NoProfileAvatarIcon,
  NotificationDot,
  Icon$10 as OpenNewIcon,
  Overlay,
  Icon$$ as PancakeRoundIcon,
  PancakeToggle,
  Icon$_ as PancakesIcon,
  Icon$Z as PencilIcon,
  Icon$Y as PlayCircleOutlineIcon,
  Icon$X as PocketWatchIcon,
  Icon$W as PoolIcon,
  Icon$V as PredictionsIcon,
  Icon$U as PresentCheckIcon,
  Icon$T as PresentNoneIcon,
  Icon$S as PresentWonIcon,
  Icon$R as PrizeIcon,
  ProfileAvatar,
  Progress,
  Bar as ProgressBar,
  Icon$Q as ProgressBunny,
  Icon$P as ProposalIcon,
  Radio,
  Icon$O as RedditIcon,
  Icon$N as RefreshIcon,
  Icon$M as RemoveIcon,
  ResetCSS,
  Icon$L as ResourcesFilledIcon,
  Icon$K as ResourcesIcon,
  Icon$J as SafePalIcon,
  Icon$I as SearchIcon,
  Icon$H as SellIcon,
  Icon$G as ShareIcon,
  Icon$F as ShrinkIcon,
  Skeleton,
  Slider,
  Icon$E as SmallDotIcon,
  Icon$D as SmartContractIcon,
  Spinner,
  Icon$C as StarFillIcon,
  Icon$B as StarLineIcon,
  Step,
  Stepper,
  SubMenu,
  SubMenuContainer,
  ...
  Icon$A as SunIcon,
  Svg,
  Icon$z as SwapFillIcon,
  Icon$y as SwapIcon,
  Icon$x as SwapVertIcon,
  Icon$w as SyncAltIcon,
  Tab,
  ButtonMenu as TabMenu,
  Table,
  Tag,
  Td,
  Icon$v as TeamBattleIcon,
  Icon$u as TeamPlayerIcon,
  Icon$t as TelegramIcon,
  Icon$s as TestnetIcon,
  Text,
  Textfield as TextField,
  Th,
  ThemeSwitcher$1 as ThemeSwitcher,
  Icon$r as Ticket,
  Icon$q as TicketFillIcon,
  Icon$r as TicketIcon,
  Icon$p as TicketRound,
  Timeline,
  Icon$o as TimerIcon,
  Toggle,
  TokenImage,
  TokenPairImage,
  Icon$n as TokenPocketIcon,
  TooltipText,
  Icon$m as TradeFilledIcon,
  Icon$l as TradeIcon,
  Icon$k as TradingViewIcon,
  Icon$j as TrophyFillIcon,
  Icon$i as TrophyGoldIcon,
  Icon$h as TrophyIcon,
  Icon$g as TrustWalletIcon,
  Icon$f as TuneIcon,
  Icon$e as TwitterIcon,
  UserMenu,
  UserMenuDivider,
  UserMenuItem,
  Icon$d as VerifiedIcon,
  Icon$c as VisibilityOff,
  Icon$b as VisibilityOn,
  Icon$a as VolumeOffIcon,
  Icon$9 as VolumeUpIcon,
  Icon$8 as VoteIcon,
  Icon$7 as WaitIcon,
  Icon$6 as WalletConnectIcon,
  Icon$5 as WalletFilledIcon,
  Icon$4 as WalletIcon,
  Icon$3 as WarningIcon,
