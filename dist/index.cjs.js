...
var Icon$2i = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$2h = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1_ = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var Icon$1X = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 23 22" }, props),
        React.createElement("path", { d: "M21.5 1l-20 20", strokeWidth: 2, stroke: "currentColor", strokeLinecap: "round" }),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7.033 19H19.5a1 1 0 100-2H9.033l-2 2zm3-3H18.5a1 1 0 001-1V6.533l-2 2V14h-2v-3.467l-2 2V14h-1.467l-2 2zm.936-8H10.5a1 1 0 00-1 1v.469L10.969 8zm-2 2L5.5 13.469V11a1 1 0 011-1h2.469zM4.5 14.469l-2 2V6a1 1 0 012 0v8.469z" })));
};
...
var Icon$1j = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 198 199" }, props),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M98.552 198.607c-29.49-.022-53.246-7.027-69.844-19.609C11.91 166.265 3 148.195 3 127.748c0-19.701 8.891-33.907 18.952-43.51 7.884-7.525 16.584-12.344 22.642-15.117-1.37-4.162-3.079-9.61-4.608-15.238-2.046-7.53-4.053-16.366-4.053-22.84 0-7.663 1.687-15.36 6.238-21.34C46.98 3.385 54.218 0 62.926 0c6.806 0 12.584 2.499 17.108 6.81 4.324 4.12 7.202 9.593 9.189 15.298 3.491 10.024 4.85 22.618 5.232 35.187h8.341c.382-12.569 1.741-25.163 5.233-35.187 1.987-5.705 4.865-11.177 9.189-15.298C121.741 2.5 127.519 0 134.325 0c8.708 0 15.947 3.385 20.755 9.703 4.551 5.98 6.239 13.677 6.239 21.34 0 6.474-2.007 15.31-4.054 22.84-1.529 5.628-3.238 11.076-4.608 15.238 6.058 2.773 14.759 7.592 22.643 15.118 10.06 9.602 18.952 23.808 18.952 43.509 0 20.447-8.911 38.517-25.708 51.25-16.598 12.582-40.354 19.587-69.844 19.609h-.148z", fill: "#633001" }),
        React.createElement("path", { d: "M62.926 7.288c-12.754 0-18.626 9.516-18.626 22.675 0 10.46 6.822 31.408 9.621 39.563.63 1.835-.36 3.844-2.164 4.555-10.222 4.031-40.39 18.789-40.39 52.588 0 35.603 30.658 62.448 87.191 62.49h.135c56.534-.042 87.19-26.887 87.19-62.49 0-33.799-30.167-48.557-40.389-52.588-1.804-.71-2.794-2.72-2.164-4.555 2.799-8.154 9.621-29.103 9.621-39.563 0-13.16-5.871-22.675-18.626-22.675-18.36 0-22.936 26.007-23.263 53.92-.022 1.863-1.528 3.375-3.392 3.375H89.58c-1.863 0-3.37-1.512-3.391-3.375-.326-27.913-4.903-53.92-23.263-53.92z", fill: "#D1884F" }),
        React.createElement("path", { d: "M98.693 177.755c-41.538 0-87.253-22.235-87.325-51.018v.134c0 35.632 30.705 62.491 87.325 62.491 56.62 0 87.325-26.859 87.325-62.491v-.134c-.072 28.783-45.787 51.018-87.325 51.018z", fill: "#FEDC90" }),
        React.createElement("path", { className: "eye", d: "M75.614 117.896c0 9.718-4.593 14.779-10.258 14.779-5.665 0-10.258-5.061-10.258-14.779s4.593-14.779 10.258-14.779c5.665 0 10.258 5.061 10.258 14.779zM142.288 117.896c0 9.718-4.592 14.779-10.257 14.779-5.666 0-10.258-5.061-10.258-14.779s4.592-14.779 10.258-14.779c5.665 0 10.257 5.061 10.257 14.779z", fill: "#633001" })));
};

var Icon$1i = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("circle", { cx: 48, cy: 48, r: 48, fill: "url(#paint0_linear_10493)" }),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M47.858 79.875c-9.342-.007-16.866-2.249-22.124-6.275-5.321-4.075-8.144-9.857-8.144-16.4 0-6.304 2.817-10.85 6.004-13.923 2.497-2.408 5.253-3.95 7.172-4.838a99.818 99.818 0 01-1.46-4.876c-.648-2.41-1.284-5.237-1.284-7.309 0-2.452.535-4.915 1.977-6.829 1.523-2.021 3.816-3.104 6.574-3.104 2.156 0 3.986.8 5.42 2.179 1.369 1.318 2.28 3.07 2.91 4.895 1.106 3.208 1.537 7.238 1.657 11.26h2.643c.12-4.022.551-8.052 1.657-11.26.63-1.825 1.541-3.577 2.91-4.895 1.434-1.38 3.264-2.18 5.42-2.18 2.758 0 5.051 1.084 6.574 3.105 1.442 1.914 1.977 4.377 1.977 6.83 0 2.071-.636 4.898-1.284 7.308a99.707 99.707 0 01-1.46 4.876c1.919.888 4.675 2.43 7.172 4.838 3.187 3.073 6.004 7.619 6.004 13.923 0 6.543-2.823 12.325-8.144 16.4-5.257 4.026-12.782 6.268-22.124 6.275h-.047z", fill: "#633001" }),
        React.createElement("path", { d: "M36.573 18.653c-4.04 0-5.9 3.045-5.9 7.256 0 3.347 2.16 10.05 3.048 12.66.199.587-.114 1.23-.686 1.458-3.238 1.29-12.794 6.012-12.794 16.828 0 11.393 9.711 19.983 27.619 19.997h.043c17.908-.014 27.619-8.604 27.619-19.997 0-10.816-9.556-15.539-12.794-16.828a1.176 1.176 0 01-.686-1.458c.887-2.61 3.048-9.313 3.048-12.66 0-4.211-1.86-7.256-5.9-7.256-5.816 0-7.266 8.322-7.37 17.254a1.084 1.084 0 01-1.074 1.08h-5.73c-.59 0-1.067-.484-1.074-1.08-.103-8.932-1.553-17.254-7.369-17.254z", fill: "#D1884F" }),
        React.createElement("path", { d: "M47.903 73.202c-13.158 0-27.64-7.115-27.662-16.326v.043c0 11.403 9.727 19.997 27.662 19.997s27.661-8.594 27.661-19.997v-.043c-.022 9.21-14.503 16.326-27.661 16.326z", fill: "#FEDC90" }),
        React.createElement("path", { d: "M40.592 54.047c0 3.11-1.455 4.73-3.25 4.73-1.794 0-3.249-1.62-3.249-4.73 0-3.11 1.455-4.73 3.25-4.73 1.794 0 3.249 1.62 3.249 4.73zM61.712 54.047c0 3.11-1.455 4.73-3.25 4.73-1.794 0-3.248-1.62-3.248-4.73 0-3.11 1.454-4.73 3.249-4.73 1.794 0 3.25 1.62 3.25 4.73z", fill: "#633001" }),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear_10493", x1: 48, y1: 0, x2: 48, y2: 96, gradientUnits: "userSpaceOnUse" },
...
var Icon$D = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M10.037 6a.75.75 0 000 1.5h7.5a.75.75 0 000-1.5h-7.5zM9.287 9.75a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM10.037 12a.75.75 0 000 1.5h7.5a.75.75 0 000-1.5h-7.5z" }),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M5.287 4a2 2 0 012-2h13a2 2 0 012 2v15c0 1.66-1.34 3-3 3h-14c-1.66 0-3-1.34-3-3v-2c0-.55.45-1 1-1h2V4zm0 16h11v-2h-12v1c0 .55.45 1 1 1zm14 0c.55 0 1-.45 1-1V4h-13v12h10c.55 0 1 .45 1 1v2c0 .55.45 1 1 1z" })));
};
...
var Icon$k = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 21 11" }, props),
    React.createElement("path", { d: "M.504.591l8.09.002.043 10.19-4.09-.03-.001-6.113L.5 4.633.504.591zM11.652 4.535a2.042 2.042 0 100-4.083 2.042 2.042 0 000 4.083zM15.787.598L20.5.603l-4.27 10.105-4.663-.01L15.754.606l.033-.008z" }))); };
        ...
        React.createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React.createElement(Flex, { alignItems: "center", pl: "12px" },
                React.createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React.createElement(Icon$x, { color: "textSubtle" })))))));
};
...
var ButtonMenu$1 = function (_a) {
    ...
    return (React.createElement(StyledButtonMenu, __assign({ disabled: disabled, variant: variant, fullWidth: fullWidth }, props), React.Children.map(children, function (child, index) {
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://hodlx-fams-frontend.vercel.app/swap?outputCurrency=0xbCe2A8350BC759Dc4c9aFDB226a608C17C88d7D9", target: "_blank" },
        React.createElement(StyledImg, { src: '/images/tokens/0xbCe2A8350BC759Dc4c9aFDB226a608C17C88d7D9.png' }),
        React.createElement(Text, { color: color, bold: true }, "$".concat(cakePriceUsd.toFixed(5))))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var ModalBackButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React.createElement(Icon$2f, { color: "primary" })));
};
    ...
    return (React.createElement(Box, __assign({ ref: setTargetRef }, props),
        ...
        hasItems && (React.createElement(StyledDropdownMenu, __assign({ style: styles.popper, ref: setTooltipRef }, attributes.popper, { "$isBottomNav": isBottomNav, "$isOpen": isMenuShow }), items
            ...
            return (React.createElement(StyledDropdownMenuItemContainer, { key: itemItem },
                type === exports.DropdownMenuItemType.BUTTON && (React.createElement(DropdownMenuItem, __assign({ "$isActive": isActive, type: "button" }, itemProps), MenuItemContent)),
                type === exports.DropdownMenuItemType.INTERNAL_LINK && (React.createElement(DropdownMenuItem, __assign({ "$isActive": isActive, as: linkComponent, href: href, onClick: function () {
                        setIsOpen(false);
                    } }, itemProps), MenuItemContent)),
                type === exports.DropdownMenuItemType.EXTERNAL_LINK && (React.createElement(DropdownMenuItem, __assign({ "$isActive": isActive, as: "a", href: href, target: "_blank", onClick: function () {
                        setIsOpen(false);
                    } }, itemProps),
                ...
                type === exports.DropdownMenuItemType.DIVIDER && React.createElement(DropdownMenuDivider, null)));
        })))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(StyledLogoWithTextIcon, { className: "mobile-icon", src: "/images/logoWithText.png" }),
...
var Menu$1 = function (_a) {
    var _b;
    var _c = _a.linkComponent, linkComponent = _c === void 0 ? 'a' : _c, userMenu = _a.userMenu, banner = _a.banner; _a.globalMenu; var isDark = _a.isDark; _a.toggleTheme; var links = _a.links, subLinks = _a.subLinks; _a.footerLinks; var activeItem = _a.activeItem, activeSubItem = _a.activeSubItem, children = _a.children;
    var isMobile = useMatchBreakpoints().isMobile;
        ...
        React.createElement(Wrapper, null,
            React.createElement(FixedContainer, { showMenu: showMenu, height: totalTopMenuHeight },
                ...
                React.createElement(StyledNav, null,
                    ...
                    React.createElement(Flex, { alignItems: "center", height: "100%" }, userMenu))),
...
var UserMenu = function (_a) {
    ...
    return (React.createElement(Flex, __assign({ alignItems: "center", height: "100%", ref: setTargetRef }, props),
        React.createElement(StyledUserMenu, { onTouchStart: function () {
            ...
            React.createElement(Icon$1T, { color: "text", width: "24px" })),
...
var Icon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "-10 0 64 62.03" }, props),
        React.createElement("path", { fill: "#afd8f7", d: "M95.21,76.12a1.51,1.51,0,0,1,1.49,1.35v.45a22.62,22.62,0,0,1-44.94.34l0-.51v-.27a1.5,1.5,0,0,1,1.49-1.36Z", transform: "translate(-51.71 -36.08)" }),
        React.createElement("path", { fill: "#182a71", d: "M52.55,36.08c10.64,0,19.18,8.26,19.18,18.46v18a1.5,1.5,0,0,1-1.5,1.5h-17a1.5,1.5,0,0,1-1.5-1.5V36.92a.83.83,0,0,1,.74-.83Z", transform: "translate(-51.71 -36.08)" }),
        React.createElement("path", { fill: "#3485c4", d: "M95.79,68l.11.36-.08-.24a13.75,13.75,0,0,1,.89,3.81,2,2,0,0,1-1.83,2.16H86.14c-5.91,0-10.73-4.18-10.88-10V53.9a1,1,0,0,1,1-1A21.42,21.42,0,0,1,95.79,68Z", transform: "translate(-51.71 -36.08)" })));
};
